...
function library:Evil()
      ...
      function(io, p)
          if io.KeyCode == UIConfig.Bind then
              if uitoggled == false then
                  ...
                  Main:TweenSize(UDim2.new(0, 520, 0, 350), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 1, true)
                  UI.Enabled = true
                  uitoggled = false
              end
          end
  ...
  Title.Text = "ZEN HUB | " .. "<font color='rgb(178, 102, 255)'>VERSION X</font>"
  Title.RichText = true
  ...
  Menu_Setting.MouseButton1Click:Connect(
      function()
          if MainPageclose == false then
              MainPageclose = true
              MainPage:TweenPosition(
          ...
          while wait(0.001) do
              pcall(
                  function()
                      ...
                      StaminaText.Text =
                          "Stamina : " ..
                          game.Players.LocalPlayer.Character.Energy.Value ..
                              "/" .. game.Players.LocalPlayer.Character.Energy.MaxValue
                      TweenService:Create(
                          LineStamina,
  ...
  Textbtn2.MouseButton1Click:Connect(
      function()
  ...
  Texbob3.MouseButton1Click:Connect(
      function()
  ...
  Texbslb4.MouseButton1Click:Connect(
      function()
  ...
  function tabs:Tab(Name, icon)
      ...
      function sections:CraftPage(side)
          ...
          function functionitem:Textbox(Name, Placeholder, callback)
              ...
              HeadTitle.Position = UDim2.new(0.6, 0, 0.04, 0)
              HeadTitle.Size = UDim2.new(0, 170, 0, 28)
              HeadTitle.ZIndex = 16
              ...
              CustomValue.FocusLost:Connect(
                  function()
                      ...
                      ConneValue:TweenPosition(
                          UDim2.new((CustomValue.Text or 0) / max, 0, 0.6, 0),
                          "Out",
                          "Sine",
                          0.2,
                          true
                      ...
                      if floor == true then
                          CustomValue.Text =
                              tostring(
                              CustomValue.Text and string.format("%.0f", (CustomValue.Text / max) * (max - min) + min)
                          )
                      else
                          CustomValue.Text =
                              tostring(CustomValue.Text and math.floor((CustomValue.Text / max) * (max - min) + min))
                      end
